...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        // Get the primary display mode for fullscreen
        ...
        // Option 2: If you prefer windowed fullscreen (comment out the above line and uncomment this)
        ...
        System.out.println("Setting fullscreen resolution to: " + displayMode.width + "x" + displayMode.height);
